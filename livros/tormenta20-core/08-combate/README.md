...
Este capítulo apresenta como construir combates e ameaças para suas aventuras, além de uma extensa coleção de criaturas organizadas por ambiente e tema. Aqui você encontrará desde bandidos comuns até dragões lendários, todos prontos para desafiar os aventureiros.

---

## 📚 Conteúdo

### 1. [Construindo Combates](01-construindo-combates.md)
- Nível de desafio (ND)
- Combates com múltiplos inimigos
...
## 🎲 Tabela Rápida: Criaturas por ND
...
| **10** | Golem de Ferro, Sacerdote de Aharadak, Tirano do Terceiro |
| **11** | Dragão Adulto, Hidra |
| **12** | Vampiro |
| **13** | Lagash |
| **14** | Colosso Supremo |
| **15** | Dragão Venerável |
...
1. Escolha criaturas com ND igual ao nível do grupo
2. Comece com combates contra 1-3 inimigos
3. Use as fichas completas - todos os números já estão calculados
4. Consulte as táticas e dicas de cada criatura

### Para Mestres Experientes
1. Ajuste o ND conforme experiência dos jogadores
2. Combine diferentes tipos de inimigos
3. Modifique criaturas conforme necessário
4. Use recursos e tesouros como recompensas

### Construindo Encontros Memoráveis
- **Ambiente:** Use o terreno a favor dos inimigos
- **Táticas:** Criaturas inteligentes devem agir de forma inteligente
- **Variedade:** Misture tipos de inimigos (corpo a corpo, à distância, conjuradores)
- **Personalidade:** Dê nome e motivação aos adversários importantes

---

## 📖 Recursos Adicionais

- **Tipos de Criaturas:** Consulte as regras na seção de construção
- **Extraindo Recursos:** Algumas criaturas possuem componentes valiosos
- **Tesouros:** Cada criatura indica categoria de tesouro
- **Personalizando:** Use as criaturas como base para criar suas próprias

---

## ⚠️ Notas Importantes

- **ND não é absoluto:** Considere composição do grupo e circunstâncias
- **Balanço:** 1-2 combates de ND igual ao nível antes de descanso
- **Ajustes:** ND menor para grupos pequenos, maior para grupos grandes
- **Preparação:** Leia as fichas antes da sessão, especialmente criaturas complexas
