---
title: "Descrição das Magias – 2º Círculo (A-F)"
...
**Execução:** 10 minutos; **Alcance:** toque; **Alvo:** 1 animal; **Duração:** permanente; **Resistência:** Vontade anula.

Um animal prestativo se torna um parceiro fiel. Quando você lança esta magia, escolhe três perícias da seguinte lista (cujo modificador seja baseado em Força, Destreza ou Constituição): Acrobacia, Adestramento, Atletismo, Cavalgar, Fortitude, Furtividade, Iniciativa, Intimidação, Luta, Percepção, Pontaria, Reflexos. O animal se torna treinado nessas perícias. Se já era treinado em uma delas, recebe +5 em testes dela. Além disso, o animal aumenta seu Intelecto em +1.

Você pode ter um número de Aliados Animais igual ao seu modificador de Sabedoria (mín. 1). Se Aliado Animal for lançada novamente sobre um animal ao qual já foi lançada, o segundo efeito não tem efeito, mas a duração é reiniciada. Um animal só pode ser alvo de um Aliado Animal por vez.

**Componente Material:** osso de animal carnívoro, T$ 100.

## Amarras Etéreas

Arcana 2 (Convocação)

**Execução:** padrão; **Alcance:** médio; **Alvo:** 1 criatura; **Duração:** cena; **Resistência:** Reflexos anula.

Você convoca cordas etéreas que prendem o alvo. Se falhar na resistência, o alvo fica enredado. No início de cada um de seus turnos, pode gastar uma ação padrão e fazer um teste de Acrobacia ou Atletismo (CD da magia) para se soltar.

**+2 PM:** além do normal, se o alvo falhar na resistência fica imóvel.

**+2 PM:** muda o alcance para curto e o alvo para criaturas escolhidas. Requer 3º círculo.
...
**Execução:** padrão; **Alcance:** médio; **Área:** esfera com 6m de raio; **Duração:** instantânea; **Resistência:** Reflexos reduz à metade.
...
**Execução:** completa; **Alcance:** curto; **Área:** cubo com 9m de lado; **Duração:** 1 dia; **Resistência:** Vontade parcial.
...
[Próximo: G-L ►](04-descricao-magias-2-circulo-gl.md) | [Voltar para Magia](README.md)
