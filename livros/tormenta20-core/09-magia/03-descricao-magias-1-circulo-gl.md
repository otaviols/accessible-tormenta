---
title: "Descrição das Magias – 1º Círculo (G-L)"
...
**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura ou objeto mundano Pequeno; **Duração:** instantânea; **Resistência:** Fortitude parcial ou Reflexos anula.

Esta magia emite um som alto e agudo. O alvo sofre 1d8+2 pontos de dano de impacto e fica atordoado por uma rodada (Fortitude reduz o dano à metade e evita o atordoamento). Se o alvo for um construto ou objeto, a magia causa dano dobrado e ignora qualquer redução de dano. Uma criatura só pode ficar atordoada por esta magia uma vez por cena.
...
**Execução:** padrão; **Alcance:** pessoal; **Alvo:** você; **Duração:** cena; **Resistência:** Vontade desacredita.
