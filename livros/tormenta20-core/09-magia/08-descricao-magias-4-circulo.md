...
> Todas as magias de 4º círculo em ordem alfabética
...
Você pode apagar ou modificar a memória recente do alvo. Ao lançar a magia, você escolhe um período de tempo de até 1 minuto que tenha acontecido nas últimas 24 horas. Você pode fazer o alvo esquecer completamente esse período ou modificar a lembrança dele sobre o que aconteceu. Se você modificar, precisa substituir por outra lembrança de duração similar — pode fazer o alvo acreditar que passou o período dormindo, conversando com você sobre o tempo, etc.
...
**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura; **Duração:** cena, até ser descarregada; **Resistência:** Vontade anula, Fortitude parcial.
...
## Convocar Aliado Supremo

Arcana 4 (Convocação)

**Execução:** padrão; **Alcance:** curto; **Efeito:** 1 criatura convocada; **Duração:** sustentada; **Resistência:** nenhuma.

Você convoca uma criatura com até ND 5. A criatura surge onde você designar, obedece completamente seus comandos mentais e não pode invocar ou convocar outras criaturas. A criatura convocada está sempre em perfeita saúde, independentemente de qualquer dano que tenha sofrido na última vez que foi convocada. A criatura desaparece se seus PV chegarem a 0 ou se a magia terminar.

**+3 PM:** aumenta o ND máximo da criatura em +1.

## Cura Completa

Divina 4 (Cura)

**Execução:** padrão; **Alcance:** toque; **Alvo:** 1 criatura; **Duração:** instantânea; **Resistência:** Vontade anula (veja texto).

Você canaliza energia positiva que recupera 10d8+20 PV no alvo. Como essa magia usa energia positiva, não pode ser usada em mortos-vivos. Ela remove as condições debilitado, enfeitiçado e envenenado, além de curar doenças e venenos. Contudo, não remove níveis negativos nem restaura níveis ou valores de atributo permanentemente drenados. Se usada contra um morto-vivo, causa dano de luz em vez de curar (Vontade reduz à metade).

**+1 PM:** aumenta a cura em +2d8+5.

**+5 PM:** também remove 1 nível negativo.

**+5 PM:** muda o alcance para curto e o alvo para criaturas escolhidas. Requer 5º círculo.

## Duplicação

Arcana 4 (Ilusão)

**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura; **Duração:** cena; **Resistência:** Vontade desacredita (veja texto).

Você cria cópias ilusórias do alvo que o imitam perfeitamente, até serem destruídas. O alvo surge com 4 cópias. Sempre que uma criatura ataca o alvo, deve rolar 1d6. Em um resultado de 1, ela atinge o alvo verdadeiro. Num resultado de 2 a 6, atinge uma cópia — e como ela foi atingida, a cópia é destruída. Uma vez que o alvo esteja sem cópias, pode ser atingido normalmente. Criaturas cegas, ou com sentidos especiais como faro ou percepção às cegas, não são afetadas.

**+1 PM:** fornece +2 na Defesa do alvo (use antes das jogadas normais por não enxergar).
...
**Execução:** padrão; **Alcance:** longo; **Alvo:** 1 criatura; **Duração:** 1 dia; **Resistência:** Fortitude anula.
...
**Execução:** padrão; **Alcance:** médio; **Efeito:** mão gigante de energia; **Duração:** sustentada.
...
**Esmagar:** a mão esmaga um oponente agarrado, causando 2d6+12 pontos de dano de impacto.
...
**Execução:** padrão; **Alcance:** médio; **Alvo:** 1 criatura; **Duração:** sustentada; **Resistência:** Fortitude anula.
...
**Execução:** padrão; **Alcance:** médio; **Efeito:** muro de ossos; **Duração:** cena.

Uma parede de ossos se eleva da terra. A parede tem 15m de comprimento, 9m de altura e 1,5m de espessura. Ela pode ter qualquer forma — não precisa ser uma linha reta —, mas sua base precisa estar sempre tocando o solo. Quando a parede surge, criaturas na área ocupada ou adjacentes sofrem 4d8 pontos de dano de corte e precisam fazer um teste de Reflexos para não ficarem presas no emaranhado de ossos. Uma criatura presa dessa maneira fica agarrada, e pode usar uma ação padrão para fazer um teste de Atletismo (CD da magia) para se soltar. Se passar no teste, sai da muralha para um dos lados adjacentes. Se falhar, sofre 4d8 pontos de dano de corte.
...
**+5 PM:** o muro é feito de uma massa de esqueletos animados. Sempre que uma criatura iniciar seu turno adjacente ou escalando a muralha, deve fazer um teste de Reflexos. Se falhar fica agarrada, sofrendo os efeitos normais de estar agarrada pela magia.
...
**Execução:** padrão; **Alcance:** médio; **Alvo:** 1 criatura; **Duração:** instantânea; **Resistência:** Fortitude parcial.

Você dispara um raio azul esbranquiçado de gelo e ar congelante. O alvo sofre 10d8 pontos de dano de frio e fica preso em um bloco de gelo (paralisado). Se passar no teste de resistência, sofre metade do dano e, em vez de paralisado, fica lento por uma rodada. É possível quebrar o gelo para libertar uma criatura presa: o bloco tem 20 PV, RD 10 e é vulnerável a fogo. Uma criatura presa pode gastar uma ação completa para fazer um teste de Atletismo e se libertar do gelo (mesma CD para resistir à magia); cada vez que passar no teste causa 10 pontos de dano ao bloco, ignorando a RD.

**+3 PM:** aumenta o dano em +2d8.

**+5 PM:** muda o alvo para área de esfera com 6m de raio. Em vez de um raio, você dispara uma bola de gelo que explode, causando o efeito da magia em todas as criaturas na área.

## Relâmpago Flamejante de Reynard

Arcana 4 (Evocação)

**Execução:** duas rodadas; **Alcance:** médio; **Efeito:** bolas de fogo e relâmpagos; **Duração:** sustentada; **Resistência:** Reflexos reduz à metade.

Esta é uma magia poderosa, desenvolvida pelo metódico e impassível arquimago Reynard. Você invoca as energias elementais do fogo e do relâmpago, fazendo com que uma de suas mãos fique em chamas e a outra mão eletrificada. Pela duração da magia, você pode gastar uma ação de movimento para disparar uma bola de fogo (6d6 pontos de dano de fogo numa esfera com 6m de raio) ou um relâmpago (6d6 pontos de dano de eletricidade numa linha). Você também pode, como uma ação padrão, usar as duas mãos num ataque de energia mista (12d12 pontos de dano, metade de fogo e metade de eletricidade, numa esfera com 6m de raio). Você precisa estar com as duas mãos livres para invocar o efeito misto e isso consome toda a energia da magia, terminando-a imediatamente. Por se tratar de um ritual complexo, o tempo de execução dessa magia não pode ser reduzido.
...
**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura; **Duração:** sustentada; **Resistência:** Fortitude anula.
...
**Execução:** padrão; **Alcance:** pessoal; **Área:** cone de 9m; **Duração:** instantânea; **Resistência:** Fortitude parcial.

Esta magia cruel foi desenvolvida pelo mago de combate Edauros, quando ainda era um bípede. Você faz um gesto rápido e dispara uma lâmina de ar das Uivantes em alta velocidade. Criaturas na área sofrem 8d8 pontos de dano de corte e ficam sangrando. Alvos que passem no teste de resistência sofrem metade do dano e não ficam sangrando.
...
**Execução:** padrão; **Alcance:** longo; **Área:** esfera com 30m de raio; **Duração:** 1 rodada; **Resistência:** veja texto.

Esta magia cria um tremor de terra que rasga o solo. O terremoto dura uma rodada, durante a qual criaturas sobre o solo ficam atordoadas. Barreiras físicas não interrompem a área de Terremoto. O efeito exato depende do terreno.
...
[◄ Anterior: 3º Círculo](06-descricao-magias-3-circulo.md) | [Voltar para Magia](README.md) | [Próximo: 5º Círculo ►](10-descricao-magias-5-circulo.md)
