---
title: "Descrição das Magias – 1º Círculo (M-R)"
...
**Execução:** reação; **Alcance:** curto; **Alvo:** 1 criatura ou objeto; **Duração:** 1 rodada; **Resistência:** Vontade anula (inofensivo).

A criatura ou objeto cai suavemente, como uma pena, e não sofre dano de queda. Esta magia afeta 10kg de peso por PM gasto (você decide quantos PM gasta ao lançá-la).

**+1 PM:** aumenta o peso afetado em +10kg.

## Raio do Enfraquecimento

Arcana 1 (Necromancia)

**Execução:** padrão; **Alcance:** médio; **Alvo:** 1 criatura; **Duração:** cena; **Resistência:** Fortitude parcial.

Um raio de energia negativa enfraquece o alvo. Se falhar na resistência, o alvo sofre penalidade de –2 na Força. Se passar, sofre penalidade de –1.

**+1 PM:** aumenta a penalidade em –1.

**+2 PM:** muda o alcance para toque. Em vez do normal, se o alvo falhar no teste de resistência, fica fraco. Se passar, sofre apenas a penalidade de –1 em Força.

## Relâmpago

Arcana 3 (Evocação)

**Execução:** padrão; **Alcance:** longo; **Área:** linha de 18m; **Duração:** instantânea; **Resistência:** Reflexos reduz à metade.

Um raio elétrico irrompe de suas mãos, causando 6d6 pontos de dano de eletricidade nas criaturas e objetos livres na área.

**+2 PM:** aumenta o dano em +2d6.

**+2 PM:** muda a área para cubo com 6m de lado. Requer 2º círculo.
...
O alvo recebe resistência 10 a um tipo de energia à sua escolha entre ácido, eletricidade, fogo, frio, luz, som ou trevas.

**+2 PM:** aumenta a resistência em +5.

**+5 PM:** muda a resistência para imunidade ao tipo de energia escolhido. Requer 3º círculo.
...
Amaldiçoa o alvo com –2 em testes de ataque, rolagens de dano e testes de resistência.
