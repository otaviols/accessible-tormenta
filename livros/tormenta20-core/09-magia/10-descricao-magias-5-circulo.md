...
> Todas as magias de 5º círculo em ordem alfabética
...
**Execução:** 1 minuto; **Alcance:** pessoal; **Alvo:** você; **Duração:** cena.

Você enxerga vislumbres do futuro, permitindo-lhe modificar o destino. Enquanto a magia durar, você pode gastar uma ação livre para rolar novamente um teste que tenha acabado de fazer. Você pode usar Alterar Destino quantas vezes quiser, mas apenas uma vez por teste.

**+0 PM:** muda o alvo para 1 criatura de sua escolha por teste. Em vez do normal, uma criatura de sua escolha que você possa ver deve rolar novamente um teste que tenha acabado de fazer. Você não pode escolher a mesma criatura duas vezes seguidas.

## Aprisionamento

Arcana 5 (Abjuração)

**Execução:** completa; **Alcance:** curto; **Alvo:** 1 criatura; **Duração:** permanente; **Resistência:** Vontade anula.
...
**Sepultamento:** o alvo é sepultado nas profundezas da terra, em uma esfera mágica. Nada pode destruir ou atravessar a esfera, nem mesmo teletransporte ou viagens planares. **Componente Material:** uma pequena esfera de mitral.

**Aprisionamento Perpétuo:** como Acorrentamento, mas o alvo também fica em animação suspensa. **Componente Material:** um círculo de poder feito de mitral e platina com custo de T$ 5.000.

**+0 PM:** muda a execução para padrão e adiciona uma condição. Em vez do normal, se uma criatura aprisionada por esta magia realizar uma condição especificada por você no momento em que a magia foi lançada, fica livre. A condição pode se basear no nome, na identidade ou no alinhamento de uma criatura, ou em ações ou qualidades observáveis, mas nunca em estatísticas intangíveis, como nível, classe ou pontos de vida. O mestre tem a palavra final sobre se uma condição é válida ou não.

## Aura Divina

Divina 5 (Abjuração)

**Execução:** padrão; **Alcance:** pessoal; **Área:** esfera com 9m de raio; **Duração:** cena; **Resistência:** Vontade parcial.
...
**Execução:** completa; **Alcance:** longo; **Efeito:** buraco negro; **Duração:** 3 rodadas; **Resistência:** Fortitude parcial.
...
Criaturas e objetos que toquem o buraco negro são sugadas, desaparecendo para sempre.
...
**Execução:** padrão; **Alcance:** médio; **Alvo:** até 10 criaturas na área; **Duração:** sustentada; **Resistência:** Vontade parcial.
...
**Execução:** duas rodadas; **Alcance:** pessoal; **Área:** cone de 30m; **Duração:** instantânea; **Resistência:** Reflexos reduz à metade.
...
**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura com menos níveis que você; **Duração:** instantânea ou veja texto; **Resistência:** Vontade parcial.
...
**Execução:** padrão; **Alcance:** longo; **Alvo:** 1 criatura; **Duração:** 1 dia; **Resistência:** Vontade anula.
...
**Execução:** padrão; **Alcance:** ilimitado (veja texto); **Alvo:** local ou criatura conhecidos; **Duração:** sustentada.
...
**Execução:** completa; **Alcance:** curto; **Alvo:** criaturas escolhidas; **Duração:** sustentada; **Resistência:** Vontade anula.
...
**Execução:** padrão; **Alcance:** curto; **Alvo:** 1 criatura; **Duração:** permanente; **Resistência:** Vontade parcial.
...
**Execução:** padrão; **Alcance:** toque; **Alvo:** 1 criatura; **Duração:** instantânea; **Resistência:** veja texto.
...
**+2 PM:** muda o alcance para curto. Em vez de tocar no alvo, você dispara um raio púrpuro da ponta de seu dedo indicador.
...
[◄ Anterior: 4º Círculo](08-descricao-magias-4-circulo.md) | [Voltar para Magia](README.md)
