---
title: "Raças de Ghanor - Variantes Condicionais"
book: "dragao-brasil"
chapter: "01-racas"
navigation:
  previous: "06-vanir.md"
  next: "08-bugbear.md"
  up: "README.md"
---
...
**Modificadores de Atributos:** Constituição +2, Inteligência +1, Carisma –1
...
Você recebe visão no escuro e +1 ponto de vida por nível.
...
**Modificadores de Atributos:** Sabedoria +2, Destreza +1, Constituição –1
...
Você recebe +2 em Furtividade e seu deslocamento é 12m (em vez de 9m).
...
Você sofre –5 em Diplomacia e Vontade. Consumir uma dose de deturlin anula esta penalidade por uma cena.

#### Tulin

Este pó fino, feito a partir da combinação de ervas e outros ingredientes naturais, é consumido por elfos para equilibrar seus sentimentos e emoções. Você pode inalar uma dose de turlin para ignorar as penalidades pela habilidade Sentimentos Conflitantes por uma cena. 

**Preço:** T$15. **Peso:** 0,5 Espaços.
...
**Modificadores de Atributos:** Força +3, Constituição +2, Inteligência –2, Sabedoria –1 ou Carisma –1.

### Grandão

Seu tamanho é Grande e você soma sua Força em seu total de pontos de vida. Você pode usar armas normais ou aumentadas, mas só pode vestir armaduras especialmente feitas para seu tamanho.
...
**Modificadores de Atributos:** Força +1, Destreza +1, Constituição +1, Carisma –1.

### Couro Duro

Você recebe redução de dano igual a sua Constituição, limitada por seu nível.
...
**Modificadores de Atributos:** Carisma +2, +1 em outro Atributo.

### Longa Infância

Você escolhe um poder sua classe que receberia no seu segundo nível.
...
## Aberrante de Ghanor (Variante de Lefou)

### Habilidades de Raça

**Modificadores de Atributos:** Carisma –2.
...
Você pode lançar uma magia arcana de 1º círculo a sua escolha (atributo-chave Inteligência ou Carisma). Se aprender novamente esta magia, seu custo diminui em –1 PM. Habilidade mágica.

#### Metamorfose

Você pode lançar Disfarce Ilusório (atributo-chave Carisma). Habilidade mágica.
...
Você recebe +1 em Força e +5 de capacidade de carga.

#### Resistente

Você recebe +1 em Constituição e resistência a magia +2.
...
[← Anterior: Vanir](06-vanir.md) | [↑ Voltar ao Índice](README.md)
