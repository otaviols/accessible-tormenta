...
prev: "06-legionario-insano"
next: "08-governador-corrupto"
---
...
**Corpo a Corpo**
- Espada curta +7 (1d6+2, 19)

**Magias**

Como um mago de 5º nível (CD 20, limite de PM 5).
...
**Equipamento:** Essência de mana, espada curta, varinha arcana.
...
**Equipamento:** Bomba x3, bomba de fumaça x3, espada curta, gazua.

**Tesouro:** Padrão.

---

## Minauro: Habilidades de Raça

**Atributos:** Força +1, +1 em dois atributos.
...
- [Governador Corrupto →](08-governador-corrupto.md)
