---
title: "Hobgoblin Gladiador"
book: "Ameaças de Arton"
chapter: "Capítulo 1: Ameaças"
section: "Duyshidakk"
prev: "07-hobgoblin-comandante"
next: "09-sangue-ayrrak"
---

# Hobgoblin Gladiador

![Ilustração de Hobgoblin Gladiador](../../_imagens/ameacas-arton/hobgoblin-gladiador.jpg)
...
| **Reflexos** | +32 |
| **Vontade** | +16 |
| **Especiais** | Imunidade a medo, resistência a magia +5 |
...
**Corpo a Corpo**
- Corrente de espinhos x4 +42 (2d4+25, 16)
...
**Equipamento:** Corrente de espinhos de mitral ameaçadora, couraça reforçada abascanta, poção de *Físico Divino* (aprimoramento para os três atributos).
...
**Navegação:**
- [← Hobgoblin Comandante Tático](07-hobgoblin-comandante.md)
- [Sangue do Ayrrak →](09-sangue-ayrrak.md)
