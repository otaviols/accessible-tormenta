...
**Parceiro:** A hiena é um parceiro especial (perseguidor) que fornece os benefícios a seguir.
...
Alternativamente, uma hiena pode ser uma montaria Média com as estatísticas de um hienodonte (a seguir).
...
| **Reflexos** | +7 |
| **Vontade** | +3 |
| **Especiais** | Resistência a medo +5 |
...
**Parceiro:** O hienodonte é um parceiro montaria (Grande) que fornece os benefícios a seguir.
