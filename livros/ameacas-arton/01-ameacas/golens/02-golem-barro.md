...
![Ilustração de Golem de Barro](../../_imagens/ameacas-arton/golem-barro.jpg)
...
A fabricação do golem de barro é um procedimento perigoso, envolvendo forçar uma combinação de centelhas elementais diferentes em uma mesma forma. Quase sempre o resultado é uma explosão arcana espetacular. Quando bem-sucedido, contudo, o processo combina a resistência da terra e a flexibilidade da água, resultando em um monstro perigoso — e instável. Criadores que tenham sobrevivido à fabricação em si podem acabar mortos pela fúria da criatura.

O golem de barro existe em tormento constante, as forças elementais que o compõem sempre em conflito, a bocarra continuamente ecoando gritos de agonia. Mas, quando está sob controle, é um guardião excepcional. Pode transformar o corpo liquefeito em uma camada no chão, parede ou teto, esperando para atacar intrusos de surpresa. Em combate, também pode disparar projéteis de lama.

Por seu espírito atormentado, é muito raro um golem de barro adquirir consciência. Quando isso acontece, para manter a sanidade, ele perde grande parte de seus poderes, adotando uma forma humanoide estável.
...
| **Reflexos** | +10 |
| **Vontade** | +16 |
| **Especiais** | Redução de dano 20/fogo |
...
**Corpo a Corpo**
- Duas pancadas +29 (2d10+25)

**À Distância**
- Tiro de lama x4 +26 (2d6+11, impacto, alcance médio)
...
- **Lama** Uma criatura atingida por um ataque do golem sofre uma penalidade cumulativa de –1 em todas as perícias. Remover a lama (e a penalidade) exige uma ação completa.
...
- [Golem de Bronze →](03-golem-bronze.md)
