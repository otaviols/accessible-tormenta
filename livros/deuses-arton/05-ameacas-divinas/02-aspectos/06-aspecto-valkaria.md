...
nd: 5
navigation:
  previous: "05-aspecto-marah.md"
  next: "../03-celestiais/README.md"
  up: "README.md"
accessibility:
  tts_optimized: true
...
**Habilidades Especiais:** Evasão  
**Imunidades:** Efeitos de movimento e medo  
**Redução de Dano:** 5  
...
Acrobacia +12, Atletismo +8.

### Equipamento

Couraça sob medida, florete certeiro preciso, sapato de camurça aprimorado.  
**Tesouro:** Nenhum.

### Parceiro

O aspecto de Valkaria é um parceiro veterano que fornece +2 em Acrobacia e em testes opostos e de resistência contra efeitos de movimento. Também permite que você use a habilidade Bloqueio Contundente (veja acima; se evitar o ataque, você causa dano igual ao dano básico de sua arma). Caso você viole as Obrigações & Restrições de Valkaria, o aspecto deixa de apoiá-lo.
