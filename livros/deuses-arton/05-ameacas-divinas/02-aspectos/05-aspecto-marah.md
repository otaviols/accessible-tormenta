---
title: "Aspecto de Marah"
book: "deuses-arton"
chapter: "05-ameacas-divinas"
navigation:
  previous: "04-aspecto-lin-wu.md"
  next: "06-aspecto-valkaria.md"
  up: "README.md"
---
...
Acrobacia +12, Atuação +16, Conhecimento +6, Diplomacia +13, Enganação +11, Intuição +9, Misticismo +6.

### Equipamento

Camisa bufante aprimorada, capa esvoaçante aprimorada, instrumento musical (varia por aspecto) aprimorado, sapatos de camurça aprimorados.  
**Tesouro:** Padrão.

### Parceiro

O aspecto de Marah é um parceiro veterano que fornece +2 em Atuação e Diplomacia e na CD de suas habilidades que causem as condições enfeitiçado, fascinado e pasmo sem causar dano. Também permite que você utilize Músicas de bardo sem precisar empunhar um instrumento. Caso você viole as Obrigações & Restrições de Marah, o aspecto deixa de apoiá-lo.
...
- [→ Aspecto de Valkaria](06-aspecto-valkaria.md)
