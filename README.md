...
1. Siga os padrões de acessibilidade em [ACCESSIBILITY_GUIDE.md](ACCESSIBILITY_GUIDE.md)
2. Use os scripts em `scripts/` para automação e validação
3. Valide frontmatter, links e acessibilidade antes de commit
