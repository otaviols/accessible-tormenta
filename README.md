# Tormenta 20 - Documentação Acessível
...
Esta é uma versão acessível e organizada do livro básico de **Tormenta 20**, o premiado RPG brasileiro ambientado no mundo de Arton. Todo o conteúdo foi convertido para Markdown com foco em:

- ✅ **Acessibilidade**: Compatível com leitores de tela (NVDA, JAWS, etc)
- ✅ **Navegação**: Links internos e estrutura hierárquica clara
- ✅ **Tabelas**: Todas as tabelas formatadas corretamente em Markdown
- ✅ **Imagens**: Alt-text descritivo para todas as ilustrações
- ✅ **Fidelidade**: Mantém nomenclaturas e conteúdo original do PDF
...
Esta documentação foi estruturada para facilitar a navegação com leitores de tela:

1. **Hierarquia de Títulos**: Use os níveis de cabeçalho (H1-H6) para navegar rapidamente
2. **Links Internos**: Todos os capítulos estão interligados com links relativos
3. **Breadcrumbs**: Cada página indica sua localização na estrutura
4. **Navegação Sequencial**: Links "Anterior" e "Próximo" no rodapé de cada página
5. **Tabelas Acessíveis**: Todas as tabelas têm cabeçalhos apropriados

### Atalhos Úteis

- **NVDA**: H (próximo título), K (próximo link), T (próxima tabela)
- **JAWS**: H (próximo título), Tab (próximo link), T (próxima tabela)

---

## 📋 Glossário Rápido

Termos frequentemente usados na documentação:
...
[Ver glossário completo →](docs/13-apendices/01-glossario.md)

---

## 📜 Créditos

**Tormenta 20** é propriedade da **Jambô Editora**.
...
- [Ver checklist de conversão](CHECKLIST.md)
...
Se você encontrar problemas de acessibilidade ou formatação, por favor documente:
- Leitor de tela usado (NVDA, JAWS, etc)
...
**Status:** Em conversão - [Ver progresso no CHECKLIST.md](CHECKLIST.md)
