...
Condições representam estados temporários que afetam personagens e criaturas durante o jogo. Elas modificam as capacidades de combate, movimento, percepção ou ações disponíveis.

**Regra Importante:** Condições com os mesmos efeitos não se acumulam; aplique apenas os mais severos. Por exemplo, um personagem desprevenido e vulnerável sofre –5 na Defesa, não –7.
...
### Caído
Deitado no chão. O personagem sofre –5 em ataques corpo a corpo e seu deslocamento é reduzido a 1,5m. Além disso, sofre –5 em Defesa contra ataques corpo a corpo, mas recebe +5 em Defesa contra ataques à distância.
...
### Desprevenido
Despreparado para reagir. O personagem sofre –5 na Defesa e em Reflexos. Você fica desprevenido contra inimigos que não possa ver.
...
### Envenenado
O efeito desta condição varia de acordo com o veneno. Pode ser perda de vida recorrente ou outra condição (como fraco ou enjoado). A descrição do veneno determina a duração dele (caso nada seja dito, a condição dura pela cena).
...
### Paralisado
O personagem fica imóvel e indefeso e só pode realizar ações puramente mentais.

**Tipo:** Movimento.

### Pasmo
O personagem não pode fazer ações.
...
### Sangrando
No início de seus turnos, o personagem deve fazer um teste de Constituição (CD 15). Se passar, estabiliza e remove essa condição. Se falhar, perde 1d6 pontos de vida e continua sangrando.
...
Algumas condições pertencem a categorias de efeitos. Personagens imunes a um tipo de efeito são imunes a todas as condições desse tipo:

- **Cansaço:** Exausto, fatigado
- **Medo:** Abalado, apavorado
- **Mental:** Alquebrado, atordoado, confuso, enfeitiçado, esmorecido, fascinado, frustrado, pasmo
- **Metabolismo:** Doente, enjoado
- **Metamorfose:** Petrificado
- **Movimento:** Agarrado, enredado, imóvel, lento, paralisado
- **Sentidos:** Cego, ofuscado, surdo
- **Veneno:** Envenenado

---

**Citação do PDF:** *"Cegueira, envenenamento, petrificação, medo... Aventureiros enfrentam todo tipo de situação adversa."*

[◂ Voltar para Apêndices](README.md) | [Tabelas de Referência](03-tabelas-referencia.md)
